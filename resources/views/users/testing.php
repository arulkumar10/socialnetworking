...
$('.like-views a').on('click', function(e) {
    e.preventDefault();
        $('.like-views').find('a').removeClass('active');
...
?>
    ...
    <div class="like-views">
        <a href="javascript:void(0)" data-href="<?php echo url('/')."/like"; ?>" data-value="articles" class="sprite like" data-id="<?php echo $article['id']; ?>" ></a>
        <strong  class="countlike"><?php echo $countlike;?></strong>
</div>  
<div class="dislike-views">
        <a href="javascript:void(0)" class="sprite dislike" data-href="<?php echo url('/')."/unlike"; ?>" data-value="articles"  data-id="<?php echo $article['id']; ?>"></a>
        <strong class="countdislike"><?php echo $countdislike;?></strong>
</div>
?>