...
<div class="container">		
	...
	<form action="{{ route('userUpdate',$user->id) }}" method="get">
		...
		<div class="form-group">
			...
			<input type="text" name="name" id="name" value="{{$user->name or old('name') }}" class="form-control"/>
		</div>

		<div class="form-group">
			<label for="email">Mail-id</label>
			<input type="text" name="email" id="email" value="{{$user->email or old('email') }}" class="form-control"/>
		</div>
